...
@SuiteClasses({
		...
		TestsForMarking.Task3ReflexiveTest.class, TestsForMarking.Task3SymmetricTest.class,
		TestsForMarking.Task3TransitiveTest.class, TestsForMarking.Tast3EquivalenceTest.class,
		TestsForMarking.Task3EquivalenceClassTest.class, TestsForMarking.Task3BFSTest.class,
